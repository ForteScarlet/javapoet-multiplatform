...
//          * [annotations][AnnotationSpec] and even other [code values][JavaCodeValue]
...
//         @JvmStatic
//         @CodePartFactory
//         public fun type(type: JavaTypeName): CodeArgumentPart = CodeArgumentPart.Type(type)
//         // TODO type(Class)
//         //  type(TypeMirror)
//         //  type(Element)
//         //  type(Any)
...
//         @JvmStatic
//         @CodePartFactory
//         public fun otherCodeValue(value: JavaCodeValue): CodeArgumentPart =
...
//      * and `Element` elements.
//      */
//     internal data class Type(val type: JavaTypeName) : CodeArgumentPart() {
//         companion object {
...
//      * Other Code Value.
//      */
//     internal data class OtherCodeValue(val value: JavaCodeValue) : CodeArgumentPart()
// }
//
